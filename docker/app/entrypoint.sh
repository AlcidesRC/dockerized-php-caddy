...
export PHP_XDEBUG_IDEKEY="${PHP_XDEBUG_IDEKEY:-PHPSTORM}"
export PHP_XDEBUG_MODE="${PHP_XDEBUG_MODE:-debug}"
export PHP_XDEBUG_START_WITH_REQUEST="${PHP_XDEBUG_START_WITH_REQUEST:-yes}"
export PHP_XDEBUG_CLIENT_HOST="${PHP_XDEBUG_CLIENT_HOST:-192.168.255.1}"
export PHP_XDEBUG_CLIENT_PORT="${PHP_XDEBUG_CLIENT_PORT:-9003}"
